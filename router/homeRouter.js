...
import {getJoin, getLogin, logout,postJoin,postLogin, githubLogin, fbLogin, postFbLogin } from '../controller/userController';
...
homeRouter.get(routes.githubCallback,passport.authenticate('github', { failureRedirect: '/login' }),postGithubLogin)


// FACEBOOK

homeRouter.get(routes.fb,fbLogin)
homeRouter.get(routes.fbCallback,passport.authenticate('facebook', { failureRedirect: '/login' }),postFbLogin)
